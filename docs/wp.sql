...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 27. Nov 2015 um 20:37
...
--
-- Tabellenstruktur für Tabelle `pma_navigationhiding`
--
...
('root', '[{"db":"wp","table":"wp_posts"},{"db":"phpmyadmin","table":"pma_column_info"},{"db":"phpmyadmin","table":"pma_designer_coords"},{"db":"phpmyadmin","table":"pma_history"},{"db":"phpmyadmin","table":"pma_pdf_pages"},{"db":"phpmyadmin","table":"pma_recent"},{"db":"phpmyadmin","table":"pma_relation"},{"db":"cdcol","table":"cds"},{"db":"mysql","table":"user"},{"db":"mysql","table":"help_relation"}]');
...
--
-- Tabellenstruktur für Tabelle `pma_savedsearches`
--
...
('root', '2015-09-02 09:05:14', '{"lang":"de","collation_connection":"utf8mb4_bin"}');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `pma_usergroups`
--
...
--
-- Tabellenstruktur für Tabelle `pma_users`
--
...
--
-- Indizes für die Tabelle `pma_bookmark`
--
ALTER TABLE `pma_bookmark`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `pma_column_info`
--
...
--
-- Indizes für die Tabelle `pma_designer_coords`
--
ALTER TABLE `pma_designer_coords`
  ADD PRIMARY KEY (`db_name`,`table_name`);

--
-- Indizes für die Tabelle `pma_history`
--
...
--
-- Indizes für die Tabelle `pma_navigationhiding`
--
ALTER TABLE `pma_navigationhiding`
  ADD PRIMARY KEY (`username`,`item_name`,`item_type`,`db_name`,`table_name`);

--
-- Indizes für die Tabelle `pma_pdf_pages`
--
...
--
-- Indizes für die Tabelle `pma_recent`
--
ALTER TABLE `pma_recent`
  ADD PRIMARY KEY (`username`);

--
-- Indizes für die Tabelle `pma_relation`
--
...
--
-- Indizes für die Tabelle `pma_savedsearches`
--
...
--
-- Indizes für die Tabelle `pma_table_coords`
--
ALTER TABLE `pma_table_coords`
  ADD PRIMARY KEY (`db_name`,`table_name`,`pdf_page_number`);

--
-- Indizes für die Tabelle `pma_table_info`
--
ALTER TABLE `pma_table_info`
  ADD PRIMARY KEY (`db_name`,`table_name`);

--
-- Indizes für die Tabelle `pma_table_uiprefs`
--
ALTER TABLE `pma_table_uiprefs`
  ADD PRIMARY KEY (`username`,`db_name`,`table_name`);

--
-- Indizes für die Tabelle `pma_tracking`
--
ALTER TABLE `pma_tracking`
  ADD PRIMARY KEY (`db_name`,`table_name`,`version`);

--
-- Indizes für die Tabelle `pma_userconfig`
--
ALTER TABLE `pma_userconfig`
  ADD PRIMARY KEY (`username`);

--
-- Indizes für die Tabelle `pma_usergroups`
--
ALTER TABLE `pma_usergroups`
  ADD PRIMARY KEY (`usergroup`,`tab`,`allowed`);

--
-- Indizes für die Tabelle `pma_users`
--
...
--
-- AUTO_INCREMENT für Tabelle `pma_bookmark`
--
ALTER TABLE `pma_bookmark`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `pma_column_info`
--
ALTER TABLE `pma_column_info`
  MODIFY `id` int(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `pma_history`
--
ALTER TABLE `pma_history`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `pma_pdf_pages`
--
ALTER TABLE `pma_pdf_pages`
  MODIFY `page_nr` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT für Tabelle `pma_savedsearches`
--
ALTER TABLE `pma_savedsearches`
  MODIFY `id` int(5) unsigned NOT NULL AUTO_INCREMENT;--
-- Datenbank: `test`
...
--
-- Indizes für die Tabelle `user_pwd`
--
...
--
-- Daten für Tabelle `wp_eo_events`
--

INSERT INTO `wp_eo_events` (`event_id`, `post_id`, `StartDate`, `EndDate`, `StartTime`, `FinishTime`, `event_occurrence`) VALUES
(1, 9, '2015-11-27', '2015-11-27', '20:30:00', '21:30:00', 0),
(2, 9, '2015-12-04', '2015-12-04', '20:30:00', '21:30:00', 1),
(3, 9, '2015-12-11', '2015-12-11', '20:30:00', '21:30:00', 2),
(4, 9, '2015-12-18', '2015-12-18', '20:30:00', '21:30:00', 3),
(5, 9, '2015-12-25', '2015-12-25', '20:30:00', '21:30:00', 4),
(6, 9, '2016-01-01', '2016-01-01', '20:30:00', '21:30:00', 5),
(7, 9, '2016-01-08', '2016-01-08', '20:30:00', '21:30:00', 6),
(8, 9, '2016-01-15', '2016-01-15', '20:30:00', '21:30:00', 7),
(9, 9, '2016-01-22', '2016-01-22', '20:30:00', '21:30:00', 8),
(10, 9, '2016-01-29', '2016-01-29', '20:30:00', '21:30:00', 9),
(11, 9, '2016-02-05', '2016-02-05', '20:30:00', '21:30:00', 10),
(12, 9, '2016-02-12', '2016-02-12', '20:30:00', '21:30:00', 11),
(13, 9, '2016-02-19', '2016-02-19', '20:30:00', '21:30:00', 12),
(14, 9, '2016-02-26', '2016-02-26', '20:30:00', '21:30:00', 13),
(15, 9, '2016-03-04', '2016-03-04', '20:30:00', '21:30:00', 14),
(16, 9, '2016-03-11', '2016-03-11', '20:30:00', '21:30:00', 15),
(17, 9, '2016-03-18', '2016-03-18', '20:30:00', '21:30:00', 16),
(18, 9, '2016-03-25', '2016-03-25', '20:30:00', '21:30:00', 17),
(19, 9, '2016-04-01', '2016-04-01', '20:30:00', '21:30:00', 18),
(20, 9, '2016-04-08', '2016-04-08', '20:30:00', '21:30:00', 19),
(21, 9, '2016-04-15', '2016-04-15', '20:30:00', '21:30:00', 20),
(22, 9, '2016-04-22', '2016-04-22', '20:30:00', '21:30:00', 21),
(23, 9, '2016-04-29', '2016-04-29', '20:30:00', '21:30:00', 22),
(24, 9, '2016-05-06', '2016-05-06', '20:30:00', '21:30:00', 23),
(25, 9, '2016-05-13', '2016-05-13', '20:30:00', '21:30:00', 24),
(26, 9, '2016-05-20', '2016-05-20', '20:30:00', '21:30:00', 25),
(27, 9, '2016-05-27', '2016-05-27', '20:30:00', '21:30:00', 26),
(28, 9, '2016-06-03', '2016-06-03', '20:30:00', '21:30:00', 27),
(29, 9, '2016-06-10', '2016-06-10', '20:30:00', '21:30:00', 28),
(30, 9, '2016-06-17', '2016-06-17', '20:30:00', '21:30:00', 29),
(31, 9, '2016-06-24', '2016-06-24', '20:30:00', '21:30:00', 30),
(32, 9, '2016-07-01', '2016-07-01', '20:30:00', '21:30:00', 31),
(33, 9, '2016-07-08', '2016-07-08', '20:30:00', '21:30:00', 32),
(34, 9, '2016-07-15', '2016-07-15', '20:30:00', '21:30:00', 33),
(35, 9, '2016-07-22', '2016-07-22', '20:30:00', '21:30:00', 34),
(36, 9, '2016-07-29', '2016-07-29', '20:30:00', '21:30:00', 35),
(37, 9, '2016-08-05', '2016-08-05', '20:30:00', '21:30:00', 36),
(38, 9, '2016-08-12', '2016-08-12', '20:30:00', '21:30:00', 37),
(39, 9, '2016-08-19', '2016-08-19', '20:30:00', '21:30:00', 38),
(40, 9, '2016-08-26', '2016-08-26', '20:30:00', '21:30:00', 39),
(41, 9, '2016-09-02', '2016-09-02', '20:30:00', '21:30:00', 40),
(42, 9, '2016-09-09', '2016-09-09', '20:30:00', '21:30:00', 41),
(43, 9, '2016-09-16', '2016-09-16', '20:30:00', '21:30:00', 42),
(44, 9, '2016-09-23', '2016-09-23', '20:30:00', '21:30:00', 43),
(45, 9, '2016-09-30', '2016-09-30', '20:30:00', '21:30:00', 44),
(46, 9, '2016-10-07', '2016-10-07', '20:30:00', '21:30:00', 45),
(47, 9, '2016-10-14', '2016-10-14', '20:30:00', '21:30:00', 46),
(48, 9, '2016-10-21', '2016-10-21', '20:30:00', '21:30:00', 47),
(49, 9, '2016-10-28', '2016-10-28', '20:30:00', '21:30:00', 48),
(50, 9, '2016-11-04', '2016-11-04', '20:30:00', '21:30:00', 49),
(51, 9, '2016-11-11', '2016-11-11', '20:30:00', '21:30:00', 50),
(52, 9, '2016-11-18', '2016-11-18', '20:30:00', '21:30:00', 51),
(53, 9, '2016-11-25', '2016-11-25', '20:30:00', '21:30:00', 52);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `wp_eo_venuemeta`
--
...
(3, 'blogname', 'Studierendenvertretung Bamberg', 'yes'),
(4, 'blogdescription', 'Blablabla', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'stuve@stuve.de', 'yes'),
...
(33, 'active_plugins', 'a:1:{i:0;s:35:"event-organiser/event-organiser.php";}', 'yes'),
...
(40, 'recently_edited', 'a:3:{i:0;s:64:"C:\\xampp\\htdocs\\wordpress/wp-content/plugins/akismet/akismet.php";i:1;s:61:"C:\\xampp\\htdocs\\wordpress/wp-content/themes/wp_test/style.css";i:2;s:0:"";}', 'no'),
(41, 'template', 'bootstrap-four', 'yes'),
(42, 'stylesheet', 'bootstrap-four', 'yes'),
...
(96, 'sidebars_widgets', 'a:3:{s:19:"wp_inactive_widgets";a:0:{}s:13:"right-sidebar";a:7:{i:0;s:8:"search-2";i:1;s:14:"recent-posts-2";i:2;s:22:"eo_event_list_widget-2";i:3;s:17:"recent-comments-2";i:4;s:10:"archives-2";i:5;s:12:"categories-2";i:6;s:6:"meta-2";}s:13:"array_version";i:3;}', 'yes'),
(98, 'cron', 'a:5:{i:1448659805;a:1:{s:19:"wp_scheduled_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}i:1448674729;a:3:{s:17:"wp_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1448689500;a:1:{s:20:"wp_maybe_auto_update";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1448729702;a:1:{s:30:"wp_scheduled_auto_draft_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}s:7:"version";i:2;}', 'yes'),
(100, '_transient_random_seed', 'd0258659c42e9ba955cee991202e6b90', 'yes'),
(101, 'nonce_key', 'sb+hJ80Y|NOaXS}>M/!*:/oq4J)4&s38ry!-%ERmQ/#OSLQm~T8-7$ Y_mrt*V_>', 'yes'),
(102, 'nonce_salt', '+s=Jb-(Pl&|y^SWYZLQE[7#XrZXNHy<RaJ}DOF4BH*J7Dg,FGg@k<N3?_jkL/jyI', 'yes'),
(113, 'auth_key', 'jAOV[v+2!Bu;{s0aiS_`AsP!tJZhebp&v*{j$?C<#K>oP{,lL.}}}L`C7VIkA#@!', 'yes'),
(114, 'auth_salt', 'aE-2Y3G9Bov/kK?+&Z?2GSJ!#Nw8Ol!L&:A<o0$kAXhF;~mdnRjq>a&&`RJob|<,', 'yes'),
(115, 'logged_in_key', '<O{e}#}`!T:*yA9pBy,RG?,kR0K`!I]p+ 8ufSdl>8V*1r4Shw+fhM)/ztmjo{.m', 'yes'),
(116, 'logged_in_salt', 'Phb.j/ImO8F1F-3Hi1Pw}v`iNYE.uHy~;#cWl;#S mnJ*@*RP@?zF>6|61tr-Ym)', 'yes'),
...
(2, 4, '_edit_last', '1'),
(3, 4, '_edit_lock', '1448643189:1'),
(8, 6, '_menu_item_type', 'custom'),
(9, 6, '_menu_item_menu_item_parent', '0'),
(10, 6, '_menu_item_object_id', '6'),
(11, 6, '_menu_item_object', 'custom'),
(12, 6, '_menu_item_target', ''),
(13, 6, '_menu_item_classes', 'a:1:{i:0;s:0:"";}'),
(14, 6, '_menu_item_xfn', ''),
(15, 6, '_menu_item_url', 'http://localhost/wordpress/'),
(17, 7, '_menu_item_type', 'post_type'),
(18, 7, '_menu_item_menu_item_parent', '0'),
(19, 7, '_menu_item_object_id', '2'),
(20, 7, '_menu_item_object', 'page'),
(21, 7, '_menu_item_target', ''),
(22, 7, '_menu_item_classes', 'a:1:{i:0;s:0:"";}'),
(23, 7, '_menu_item_xfn', ''),
(24, 7, '_menu_item_url', ''),
(26, 9, '_eventorganiser_schedule_until', '2016-11-27 20:30:00'),
(27, 9, '_edit_last', '1'),
(28, 9, '_edit_lock', '1448652278:1'),
(29, 9, '_eventorganiser_event_schedule', 'a:8:{s:7:"all_day";i:0;s:8:"schedule";s:6:"weekly";s:13:"schedule_meta";a:1:{i:0;s:2:"FR";}s:9:"frequency";i:1;s:7:"exclude";a:0:{}s:7:"include";a:0:{}s:12:"duration_str";s:55:"+0 year +0 month +0 days +1 hours +0 minutes +0 seconds";s:12:"_occurrences";a:53:{i:1;s:19:"2015-11-27 20:30:00";i:2;s:19:"2015-12-04 20:30:00";i:3;s:19:"2015-12-11 20:30:00";i:4;s:19:"2015-12-18 20:30:00";i:5;s:19:"2015-12-25 20:30:00";i:6;s:19:"2016-01-01 20:30:00";i:7;s:19:"2016-01-08 20:30:00";i:8;s:19:"2016-01-15 20:30:00";i:9;s:19:"2016-01-22 20:30:00";i:10;s:19:"2016-01-29 20:30:00";i:11;s:19:"2016-02-05 20:30:00";i:12;s:19:"2016-02-12 20:30:00";i:13;s:19:"2016-02-19 20:30:00";i:14;s:19:"2016-02-26 20:30:00";i:15;s:19:"2016-03-04 20:30:00";i:16;s:19:"2016-03-11 20:30:00";i:17;s:19:"2016-03-18 20:30:00";i:18;s:19:"2016-03-25 20:30:00";i:19;s:19:"2016-04-01 20:30:00";i:20;s:19:"2016-04-08 20:30:00";i:21;s:19:"2016-04-15 20:30:00";i:22;s:19:"2016-04-22 20:30:00";i:23;s:19:"2016-04-29 20:30:00";i:24;s:19:"2016-05-06 20:30:00";i:25;s:19:"2016-05-13 20:30:00";i:26;s:19:"2016-05-20 20:30:00";i:27;s:19:"2016-05-27 20:30:00";i:28;s:19:"2016-06-03 20:30:00";i:29;s:19:"2016-06-10 20:30:00";i:30;s:19:"2016-06-17 20:30:00";i:31;s:19:"2016-06-24 20:30:00";i:32;s:19:"2016-07-01 20:30:00";i:33;s:19:"2016-07-08 20:30:00";i:34;s:19:"2016-07-15 20:30:00";i:35;s:19:"2016-07-22 20:30:00";i:36;s:19:"2016-07-29 20:30:00";i:37;s:19:"2016-08-05 20:30:00";i:38;s:19:"2016-08-12 20:30:00";i:39;s:19:"2016-08-19 20:30:00";i:40;s:19:"2016-08-26 20:30:00";i:41;s:19:"2016-09-02 20:30:00";i:42;s:19:"2016-09-09 20:30:00";i:43;s:19:"2016-09-16 20:30:00";i:44;s:19:"2016-09-23 20:30:00";i:45;s:19:"2016-09-30 20:30:00";i:46;s:19:"2016-10-07 20:30:00";i:47;s:19:"2016-10-14 20:30:00";i:48;s:19:"2016-10-21 20:30:00";i:49;s:19:"2016-10-28 20:30:00";i:50;s:19:"2016-11-04 20:30:00";i:51;s:19:"2016-11-11 20:30:00";i:52;s:19:"2016-11-18 20:30:00";i:53;s:19:"2016-11-25 20:30:00";}}'),
(30, 9, '_eventorganiser_schedule_start_start', '2015-11-27 20:30:00'),
(31, 9, '_eventorganiser_schedule_start_finish', '2015-11-27 21:30:00'),
(32, 9, '_eventorganiser_schedule_last_start', '2016-11-25 20:30:00'),
(33, 9, '_eventorganiser_schedule_last_finish', '2016-11-25 21:30:00');
...
(1, 1, '2015-09-02 15:38:48', '2015-09-02 13:38:48', 'Willkommen zur deutschen Version von WordPress. Dies ist der erste Beitrag. Du kannst ihn bearbeiten oder löschen. Um Spam zu vermeiden, geh doch gleich mal in den Pluginbereich und aktiviere die entsprechenden Plugins. So, und nun genug geschwafelt – jetzt nichts wie ran ans Bloggen!', 'Hallo Welt!', '', 'publish', 'open', 'open', '', 'hallo-welt', '', '', '2015-09-02 15:38:48', '2015-09-02 13:38:48', '', 0, 'http://localhost/wordpress/?p=1', 0, 'post', '', 1),
(2, 1, '2015-09-02 15:38:48', '2015-09-02 13:38:48', 'Dies ist ein Beispiel einer statischen Seite. Du kannst sie bearbeiten und beispielsweise Infos über dich oder das Weblog eingeben, damit die Leser wissen, woher du kommst und was du machst.\n\nDu kannst entweder beliebig viele Hauptseiten (wie diese hier) oder Unterseiten, die sich in der Hierachiestruktur den Hauptseiten unterordnen, anlegen. Du kannst sie auch alle innerhalb von WordPress ändern und verwalten.\n\nAls stolzer Besitzer eines neuen WordPress-Seite, solltest du zur Übersichtsseite, dem <a href="http://localhost/wordpress/wp-admin/">Dashboard</a> gehen, diese Seite löschen und damit loslegen, eigene Inhalte zu erstellen. Viel Spaß!', 'Beispiel-Seite', '', 'publish', 'open', 'open', '', 'beispiel-seite', '', '', '2015-09-02 15:38:48', '2015-09-02 13:38:48', '', 0, 'http://localhost/wordpress/?page_id=2', 0, 'page', '', 0),
(4, 1, '2015-11-27 17:55:17', '2015-11-27 16:55:17', 'Yay', 'Hallo Bamberg', '', 'publish', 'open', 'open', '', 'hallo-bamberg', '', '', '2015-11-27 17:55:29', '2015-11-27 16:55:29', '', 0, 'http://localhost/wordpress/?p=4', 0, 'post', '', 0),
(5, 1, '2015-11-27 17:55:17', '2015-11-27 16:55:17', 'Yay', 'Hallo Bamberg', '', 'inherit', 'closed', 'closed', '', '4-revision-v1', '', '', '2015-11-27 17:55:17', '2015-11-27 16:55:17', '', 4, 'http://localhost/wordpress/2015/11/27/4-revision-v1/', 0, 'revision', '', 0),
(6, 1, '2015-11-27 20:23:46', '2015-11-27 19:23:46', '', 'Startseite', '', 'publish', 'closed', 'closed', '', 'startseite', '', '', '2015-11-27 20:25:07', '2015-11-27 19:25:07', '', 0, 'http://localhost/wordpress/?p=6', 1, 'nav_menu_item', '', 0),
(7, 1, '2015-11-27 20:23:46', '2015-11-27 19:23:46', ' ', '', '', 'publish', 'closed', 'closed', '', '7', '', '', '2015-11-27 20:25:07', '2015-11-27 19:25:07', '', 0, 'http://localhost/wordpress/?p=7', 2, 'nav_menu_item', '', 0),
(8, 1, '2015-11-27 20:24:17', '0000-00-00 00:00:00', '', 'Automatisch gespeicherter Entwurf', '', 'auto-draft', 'open', 'open', '', '', '', '', '2015-11-27 20:24:17', '0000-00-00 00:00:00', '', 0, 'http://localhost/wordpress/?p=8', 0, 'post', '', 0),
(9, 1, '2015-11-27 20:26:56', '2015-11-27 19:26:56', '', 'KIT-Treffen', '', 'publish', 'closed', 'closed', '', 'kit-treffen', '', '', '2015-11-27 20:26:56', '2015-11-27 19:26:56', '', 0, 'http://localhost/wordpress/?post_type=event&#038;p=9', 0, 'event', '', 0);
...
(1, 1, 'category', '', 0, 2),
(2, 2, 'nav_menu', '', 0, 2),
(3, 3, 'event-category', '', 0, 1),
(4, 4, 'event-category', '', 3, 1);
...
(14, 1, 'session_tokens', 'a:1:{s:64:"dc01791f0c3da175bf0490cc3b6b4616d8ac641cabceb56484e470029cbc7093";a:4:{s:10:"expiration";i:1448814868;s:2:"ip";s:3:"::1";s:2:"ua";s:108:"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36";s:5:"login";i:1448642068;}}'),
(15, 1, 'wp_dashboard_quick_press_last_post_id', '8'),
(16, 1, 'managenav-menuscolumnshidden', 'a:5:{i:0;s:11:"link-target";i:1;s:11:"css-classes";i:2;s:3:"xfn";i:3;s:11:"description";i:4;s:15:"title-attribute";}'),
(17, 1, 'metaboxhidden_nav-menus', 'a:5:{i:0;s:9:"add-event";i:1;s:12:"add-post_tag";i:2;s:15:"add-event-venue";i:3;s:18:"add-event-category";i:4;s:13:"add-event-tag";}'),
(18, 2, 'nickname', 'stuve'),
(19, 2, 'first_name', 'Stu'),
(20, 2, 'last_name', 'Ve'),
(21, 2, 'description', ''),
...
(1, 'chabo', '$P$BMHPNm1RG/Olbt0asruVsf7swsJ6ql/', 'chabo', 'chabo@stuve.de', '', '2015-09-02 13:38:47', '', 0, 'chabo'),
(2, 'stuve', '$P$BPU6JUeYJG/Z1U/XNCSoIsOoQPaknm/', 'stuve', 'stuve@stuve.de', '', '2015-11-27 19:28:25', '1448652508:$P$B2MBQbstTFgOGsFPlLtQs/JwOX9ysr.', 0, 'Stu Ve');
...
--
-- Indizes für die Tabelle `wp_eo_events`
--
...
--
-- Indizes für die Tabelle `wp_eo_venuemeta`
--
...
--
-- AUTO_INCREMENT für Tabelle `wp_eo_events`
--
ALTER TABLE `wp_eo_events`
  MODIFY `event_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT für Tabelle `wp_eo_venuemeta`
--
ALTER TABLE `wp_eo_venuemeta`
  MODIFY `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
